  ...
  return (
    <div className="h-screen w-full overflow-hidden flex content-center">
      <div className="absolute -z-1 h-full w-full overflow-hidden [mask-image:radial-gradient(0%,white,transparent)]">
        <div className="absolute -z-1 inset-0 before:absolute before:inset-0  bg-[radial-gradient(circle_at_center,#021318_0%,#0b0b0b_70%,transparent_70%)] before:opacity-100" />
        <Sparkles
          density={1200}
