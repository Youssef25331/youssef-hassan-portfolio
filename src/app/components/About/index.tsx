...
const About = () => {
  return (
    <div className='flex items-center justify-center'>
      <div className="flex flex-col justify-center items-center w-120 md:w-160 lg:w-220 gap-1">
        ...
        <div className="flex flex-col justify-center items-center gap-8 mt-5">
          <p className='text-lg md:text-xl md:w-130 lg:text-2xl text-center text-white/70 w-100 lg:w-180 lg:leading-12'>
