...
const About = () => {
  return (
    <div className='flex items-center justify-center'>
      <div className="flex flex-col justify-center items-center w-255 gap-1">
        <h2 className='text-2xl text-white/70'>About me</h2>
        <h1 className='text-6xl text-shadow-main text-center'>A Full-Stack web developer dedicated to turning ideas into creative solutions</h1>
        <div className="flex flex-col justify-center items-center gap-8 mt-5">
          <p className='text-3xl text-center text-white/70 w-200 leading-12'>
