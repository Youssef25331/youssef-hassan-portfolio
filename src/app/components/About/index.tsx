...
const About = () => {
  return (
    <div className='flex items-center justify-center'>
      <div className="flex flex-col justify-center items-center w-120 lg:w-220 gap-1">
        <h2 className='text-lg lg:text-2xl text-white/70'>About me</h2>
        <h1 className='text-2xl lg:text-5xl text-shadow-main text-center'>A Full-Stack web developer dedicated to turning ideas into creative solutions</h1>
        <div className="flex flex-col justify-center items-center gap-8 mt-5">
          <p className='text-lg lg:text-2xl text-center text-white/70 w-100 lg:w-180 lg:leading-12'>
